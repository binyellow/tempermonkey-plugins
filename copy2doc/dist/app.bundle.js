...
/* harmony import */ var _public_icon_jpg__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../public/icon.jpg */ "./public/icon.jpg");
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var _default = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(_default, [{
    ...
    value: function componentDidMount() {
      ...
      }, false); // document.addEventListener("copy", function (e) {
    ...
    value: function handleCopy() {
      ...
      setTimeout(function () {
        document.getElementById("CommentDescriptionEditor_ifr").contentWindow.document.addEventListener("copy", /*#__PURE__*/function () {
          var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
            var data, typeArr, i, type, _data;

            return regeneratorRuntime.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    data = window.clipboardData || e.clipboardData;
                    e.preventDefault();
                    typeArr = data.types;

                    for (i = 0; i < data.items.length; i++) {
                      type = typeArr[i];
                      _data = e.clipboardData.getData(type);
                      e.clipboardData.setData(type, _data.replace(/([-a-zA-Z0-9@:%_+.~#?&//=]{2,256}\.[a-z]{2,4}\b([-a-zA-Z0-9@:%_+.~#?&//=]*)?)/g, function ($1) {
                        return "http://tapd.oa.com".concat($1);
                      }));
                      console.log(_data);
                    }
...
wokooApp.id = 'wokooApp-copy2doc-19945';
